/**
 * Quick test script for the monthly report email.
 * Usage: npx tsx scripts/test-monthly-report.ts [your@email.com]
 *
...
const { default: handler } = await import('../api/monthly-report')
...
console.log('🚀 Running monthly report handler...\n')
